...
export function getPlaylistCover(p: { id: string; customCover?: string | null; tracks: { cover?: string | null }[] }): string | null {
  return p.id === 'p1' ? null : (p.customCover || p.tracks[0]?.cover || null);
}
